...
namespace ClarityDesk.Migrations
{
    ...
    [Migration("20251124005540_ChangeRecordDateToDateTime2")]
    partial class ChangeRecordDateToDateTime2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClarityDesk.Models.Entities.LineBinding", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasFilter("[BindingStatus] = 'Active'");

                    b.ToTable("LineBindings", (string)null);
                });

            modelBuilder.Entity("ClarityDesk.Models.Entities.LineConversationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("LineUserId", "ExpiresAt");

                    b.ToTable("LineConversationSessions", (string)null);
                });

            modelBuilder.Entity("ClarityDesk.Models.Entities.LineMessageLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("IssueReportId")
                        .HasFilter("[IssueReportId] IS NOT NULL");

                    b.HasIndex("LineUserId", "SentAt");

                    b.HasIndex("SentAt", "MessageType", "IsSuccess");

                    b.ToTable("LineMessageLogs", (string)null);
                });
