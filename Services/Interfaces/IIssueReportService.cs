...
public interface IIssueReportService
{
    ...
    /// <param name="cancellationToken">取消權束</param>
    /// <returns>是否更新成功</returns>
    Task<bool> UpdateIssueReportAsync(int id, UpdateIssueReportDto dto, int currentUserId, CancellationToken cancellationToken = default);
